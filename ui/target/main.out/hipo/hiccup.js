...
hipo.hiccup.default_namespaces = new cljs.core.PersistentArrayMap(null, 1, ["svg","http://www.w3.org/2000/svg"], null);
hipo.hiccup.key__GT_namespace = (function hipo$hiccup$key__GT_namespace(s,m){
if(cljs.core.truth_(s)){
var or__5056__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469).cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__12831 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__12831;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__5044__auto__ = id;
...
if(cljs.core.truth_((function (){var or__5056__auto__ = id;
if(cljs.core.truth_(or__5056__auto__)){
return or__5056__auto__;
} else {
return cs;
...
hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__5654__auto__,writer__5655__auto__,opt__5656__auto__){
return cljs.core._write.call(null,writer__5655__auto__,"hipo.hiccup/Sentinel");
});
...
var G__12833 = (function (){var f = cljs.core.first.call(null,s);
if(cljs.core.truth_((function (){var or__5056__auto__ = hipo.hiccup.literal_QMARK_.call(null,f);
if(cljs.core.truth_(or__5056__auto__)){
return or__5056__auto__;
} else {
...
var G__12834 = cljs.core.rest.call(null,s);
v = G__12833;
s = G__12834;
continue;
} else {
...
var G__12835 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.hiccup.conjs_BANG_.call(null,acc,f):((!((f == null)))?cljs.core.conj_BANG_.call(null,acc,f):acc
));
var G__12836 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__12835;
v__$1 = G__12836;
continue;
}
